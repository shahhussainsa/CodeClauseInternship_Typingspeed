...
class TypingTest:
	...
	def __init__(self) -> None:
		...
		self.window = Tk()
		self.window.geometry("1000x680+0+0")
		self.window.title("Speed Typing Test in Python")
		self.window.configure(bg = "#00FFFF")
		self.window.minsize(1300, 680)
    # self.window.iconbitmap(default='password.ico')
		self.current_frame = Frame(self.window, bg = "#00FFFF", width = 1000, height = 600)
	...
	def show_typing_result(self) -> None:
		...
		result = Label(self.current_frame, text = "Result", fg = 'white', bg = 'black', font= 'Lucida\ Calligraphy 26 underline')
		result.grid(row = 0, columnspan = 3, pady = 40)

		lb_accuracy = Label(self.current_frame, text = 'Accuracy', fg = 'black', bg = '#00FA9A', font= 'Lucida\ Fax 22')
		lb_accuracy.grid(row = 1, column = 0)
		accuracy_val = Label(self.current_frame,text= f'{accuracy}%', fg = 'red', bg = '#BDFCC9', font = 'Lucida\ Fax 22 bold')
		accuracy_val.grid(row = 1, column = 1, columnspan = 2)

		lb_actual_accuracy = Label(self.current_frame, text = 'Actual Accuracy', fg = 'black', bg = '#00FA9A', font= 'Lucida\ Fax 22')
		lb_actual_accuracy.grid(row = 2, column = 0, pady = (25, 0))
		accuracy_actual_val = Label(self.current_frame,text= f'{actual_accuracy}%', fg = 'red', bg = '#BDFCC9', font = 'Lucida\ Fax 22 bold')
		accuracy_actual_val.grid(row = 2, column = 1, columnspan = 2, pady= (25, 0))

		lb_wpm = Label(self.current_frame, text = "Word Per Minute", fg = 'black', bg = '#00FA9A', font= 'Lucida\ Fax 22')
		lb_wpm.grid(row = 3, column = 0)
		val_wpm = Label(self.current_frame, text = f'{wpm}', fg = 'red', bg = '#BDFCC9', font = 'Lucida\ Fax 22 bold')
		val_wpm.grid(row =3, column = 1, columnspan = 2, pady = 25)

		lb_time = Label(self.current_frame, text = "Total Time", fg = 'black', bg = '#00FA9A', font= 'Lucida\ Fax 22')
		lb_time.grid(row = 4, column = 0)
		val_time = Label(self.current_frame, text = f'{total_time}', fg = 'red', bg = '#BDFCC9', font = 'Lucida\ Fax 22 bold')
		val_time.grid(row =4, column = 1, columnspan = 2)

		lb_exit = Button(self.current_frame, text = 'EXIT', fg = 'red', bg = 'black', font= 'Verdana\ Pro 18 bold', borderwidth = 3,justify = 'left', command = self.get_exit)
		lb_exit.grid(row = 5, column = 1, pady = 50, padx = 20)
		lb_home = Button(self.current_frame, text = 'HOME', fg = 'red', bg = 'black', font= 'Verdana\ Pro 18 bold', borderwidth = 3, command = self.back_to_home)
	...
	def key_release(self, event) -> None:
		...
		if self.paragraph.startswith(self.get_user_text):
			self.user_input.config(fg= 'blue')
		else:
	...
	def start_typing(self) -> None:
		...
		global time_count 
		time_count = Label(self.current_frame, fg= 'yellow', bg = 'black', text = '00:00', font = 'Lucida\ Console 22 bold')
		time_count.grid(row= 0, column= 2, pady= 50)

		place_holder = Message(self.current_frame, text = self.paragraph, fg = 'black', bg = 'white', width = 1000, justify = 'center', font = 'Verdana\ Pro 18')
	...
	def set_typing_home(self) -> None:
		...
		backward = Button(self.current_frame,
            text= '<<',
            bg= '#757575', fg= 'white', relief = RAISED,
            font='Helvetica 20',
            state= DISABLED, command = lambda: self.go_backward(backward, forward, title, place_holder))
		
		
		title = Label(self.current_frame, fg = 'black', bg = '#EAEAEA', text = self.topic.get(), font = 'Helvetica 22')
		...
		place_holder = Message(self.current_frame, text = self.paragraph, fg = 'white', bg = 'black', width = 1000, justify = 'center', font = 'Verdana\ Pro 18')
		place_holder.grid(row= 3, column= 0, columnspan= 3)

		start_test = Button(self.current_frame, text = "Start Test", font = 'Verdana\ Pro 15', borderwidth = 3, bg = 'yellow', fg = 'black', relief = RAISED, command = self.start_typing)
		...
		exit = Button(self.current_frame,
            ...
            font= 'Verdana\ Pro 15',
            borderwidth= 3,
            bg= 'yellow', fg= 'black', relief = RAISED,
